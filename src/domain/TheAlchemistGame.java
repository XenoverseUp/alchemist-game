    ...
    public void initialize() {
        ...
        while (currentUser < 2) {
            ...
            while (username == null || username == "") {
                System.out.printf("Seems like you haven't picked one, yet. Pick a name for the %s player: ",
                        currentUser == 0 ? "first" : "second");
                username = scanner.nextLine();
            }

            System.out.println(
                    "Well, now that you have a wizard name, pick an avatar. Here are the available avatars and default avatar is `Galactic`:\n");
        ...
        System.out.println(
                "Great! All alchemists are ready to brew. Let's move to our alchemy board to start the adventure.");
        ...
        SwingUtilities.invokeLater(() -> {
            GameBoard gameBoard = new GameBoard(auth);
